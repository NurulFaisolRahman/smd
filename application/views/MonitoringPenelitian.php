                              ...
                              <tbody>
                                <?php $No = 1; foreach ($Rencana as $key) { ?>
                                  <tr>	
                                    ...
                                    <td class="text-center align-middle"><?=$key['TargetKajur']?>&nbsp;<button EditRencanaPenelitian="<?=$key['No']."/".$key['Jabatan']."/".$key['Jenjang']."/".$key['Semester']."/".$key['Tahun']."/".$key['KodeRencana']."/".$key['TotalKredit']."/".$key['TargetKajur']?>" class="btn btn-sm btn-success EditRencanaPenelitian"><i class="fas fa-edit"></i></button></td>
                                  </tr>
                                <?php } ?>
                              </tbody>
                            </table>
