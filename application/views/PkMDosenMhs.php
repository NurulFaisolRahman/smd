<div class="content-wrapper">
              ...
              <div class="col-sm-12 mt-2">
                <div class="container-fluid border border-warning rounded bg-light">
                  <div class="row align-items-center">
                    ...
                    <button type="button" class="btn btn-primary text-light mb-2" data-toggle="modal" data-target="#ModalInputPkMDosenMhs"><i class="fa fa-plus"></i> <b>Input Data</b></button> 
                      <div class="table-responsive mb-2">
                        <table id="TabelPkMDosenMhs" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            <?php $No = 1; foreach ($PkMDosenMhs as $key) { ?>
                              <tr>	
                                ...
                                <td class="text-center align-middle">
                                  ...
                                  <button LihatSertifikat="<?=base_url('PkMDosenMhs/'.$key['Bukti'])?>" class="btn btn-sm btn-primary LihatSertifikat"><i class="fas fa-download"></i></button>  
                                </td> 
                              </tr>
                            <?php } ?>
                          </tbody>
    ...
    <div class="modal fade" id="ModalInputPkMDosenMhs">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-warning">
            ...
            <div class="container">
                ...
                <div class="col-sm-12">
                  <div class="input-group input-group-sm mb-2">
                    ...
                    <input type="text" class="form-control" id="Tema" placeholder="Input Tema PkM sesuai Roadmap"> 
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="input-group input-group-sm mb-2">
          ...
          <div class="modal-footer justify-content-between">
            ...
            <button type="submit" class="btn btn-success" id="InputPkMDosenMhs"><b>Simpan</b></button>
          </div>
        </div>
      </div>
    </div>
    <div class="modal fade" id="ModalEditPkMDosenMhs">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-warning">
          <div class="modal-body">
            <div class="container">
                ...
                <div class="col-sm-12">
                  <div class="input-group input-group-sm mb-2">
                    ...
                    <input type="text" class="form-control" id="EditTema" placeholder="Input Tema PkM sesuai Roadmap"> 
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="input-group input-group-sm mb-2">
                ...
                <div class="col-sm-8">
                  <div class="input-group input-group-sm mb-2">
                    ...
                    <div class="input-group-prepend">
                      <button class="input-group-text bg-primary" id="CancelPkMDosenMhs"><b>X</b></button>
                    </div>
                  </div>
                  <pre class="text-danger"><b>Bukti Yang Diupload Dalam Format Pdf</b></pre>
                </div>
          ...
          <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-danger" data-dismiss="modal"><b>Tutup</b></button>
            <button type="submit" class="btn btn-success" id="UpdatePkMDosenMhs"><b>Simpan</b></button>
          </div>
        </div>
      </div>
    </div>
    ...
    <script src="<?=base_url('bootstrap/js/Borang.js')?>"></script>
        ...
        $("#CancelPkMDosenMhs").click(function() {
					$("#EditBukti").val("")
				})

        $("#InputPkMDosenMhs").click(function() {
          if ($("#Dosen").val() == "") {
            ...
            $.ajax({
							url: BaseURL+'Admin/InputPkMDosenMhs',
							type: 'post',
							data: fd,
							contentType: false,
							processData: false,
							success: function(Respon){
								if (Respon == '1') {
									window.location = BaseURL + "Admin/PkMDosenMhs"
								}
								else {
									alert(Respon)
								}
        ...
        $(document).on("click",".Edit",function(){
          ...
          $('#ModalEditPkMDosenMhs').modal("show")
				}) 

				$("#UpdatePkMDosenMhs").click(function() {
					if ($("#EditDosen").val() == "") {
            alert('Mohon Input Nama Dosen!')
            ...
            $.ajax({
							url: BaseURL+'Admin/UpdatePkMDosenMhs',
							type: 'post',
							data: fd,
							contentType: false,
							processData: false,
        ...
        $(document).on("click",".Hapus",function(){
      		...
      		if (Konfirmasi == true) {
						$.post(BaseURL+"Admin/HapusPkMDosenMhs", Hapus).done(function(Respon) {
							if (Respon == '1') {
								window.location = BaseURL + "Admin/PkMDosenMhs"
							} else {
								alert(Respon)
