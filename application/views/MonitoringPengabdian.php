<div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-sm-12 mt-2">
                <ul class="nav nav-pills mb-2 border border-warning rounded bg-light" id="pills-tab" role="tablist">
                  <li class="nav-item">
                      <a class="nav-link active" id="pills-MonitoringPengabdian-tab" data-toggle="pill" href="#pills-MonitoringPengabdian" role="tab" aria-controls="pills-MonitoringPengabdian" aria-selected="true"><i class="nav-icon fas fa-users"></i><b> Monitoring Pengabdian</b></a>
                  </li>
                </ul>
                              ...
                              <tbody>
                                <?php $No = 1; foreach ($Rencana as $key) { ?>
                                  <tr>	
                                    ...
                                    <td class="text-center align-middle"><?=$key['TargetKajur']?>&nbsp;<button EditRencanaPengabdian="<?=$key['No']."/".$key['Jabatan']."/".$key['Jenjang']."/".$key['Semester']."/".$key['Tahun']."/".$key['KodeRencana']."/".$key['TotalKredit']."/".$key['TargetKajur']?>" class="btn btn-sm btn-success EditRencanaPengabdian"><i class="fas fa-edit"></i></button></td>
                                  </tr>
                                <?php } ?>
                              </tbody>
                            </table>
                  ...
                  <div class="table-responsive mb-2">
                    <table id="EditPengabdian" class="table table-bordered border-dark bg-light mb-1">
                      ...
                      <tr>
                        ...
                        <tr>
                          <td class='align-middle'>a) Hasil Pengabdian atau hasil pemikiran yang dipublikasikan dalam bentuk buku</td>
                          <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td class='align-middle'>b) Hasil Pengabdian atau hasil pemikiran dalam buku yang dipublikasikan dan berisi berbagai tulisan dari berbagai penulis (book chapter) : </td>
                          <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td class='align-middle'>c) Hasil Pengabdian atau hasil pemikiran yang dipublikasikan : </td>
                          <td></td>
                        </tr>
                        <tr>
                    ...
                    <table id="Pengabdian" class="table table-bordered border-dark bg-light mb-1">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class='align-middle'>Hasil Pengabdian atau hasil pemikiran yang didesiminasikan </td>
                          <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td class='align-middle'> d. Hasil Pengabdian / pemikiran yang tidak disajikan dalam seminar / simposium / lokakarya, tetapi dimuat dalam prosiding : </td>
                          <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td class='align-middle'><label><input disabled type="checkbox" id="EditRencanaPNL28" onchange="EditRencanaPNL28()"> e. Hasil Pengabdian / pemikiran yang disajikan dalam koran / majalah populer / umum </label></td>
                          <td class='text-center align-middle'><b id="EditRencanaKreditPNL28">0</b></td>
                        </tr>
                        <tr>
                          <td class='text-center'>3</td>
                          <td class='align-middle'><label><input disabled type="checkbox" id="EditRencanaPNL29" onchange="EditRencanaPNL29()"> Hasil Pengabdian atau pemikiran atau kerjasama industri yang tidak dipublikasikan (tersimpan dalam perpustakaan) yang dilakukan secara melembaga </label></td>
    ...
    <script src="<?=base_url('bootstrap/js/bootstrap.min.js')?>"></script>
		...
		<script>
			var EditJabatanRencanaPengabdian = ''
